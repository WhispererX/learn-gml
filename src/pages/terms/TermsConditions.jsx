...
function TermsConditions() {
  document.title = 'Terms & Conditions | LearnGML';
  return (
    <>
      <Header />
      <main className='document'>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              "We", "Us" or "Our" in this Agreement) refers to LearnGML.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to LearnGML, accessible from{' '}
              <a
                href="https://www.learngml.com"
                rel="external nofollow noopener"
                target="_blank">
                https://www.learngml.com
              </a>
            </p>
          </li>
          <li>
        ...
        <p>
          <strong>The Service is available to users of all ages.</strong> Minors
          may use the Service without restriction, as we do not collect any
          personal data or require account registration.
        </p>
        <p>
          Your access to and use of the Service is also conditioned on Your
          acceptance of and compliance with the{' '}
          <Link to="/privacy">Privacy Policy</Link> of the Company. Our{' '}
          <Link to="/privacy">Privacy Policy</Link> describes Our policies and
          procedures on the collection, use and disclosure of Your personal
          information when You use the Website and tells You about Your privacy
          rights and how the law protects You. Please read Our{' '}
          <Link to="/privacy">Privacy Policy</Link>
          carefully before using Our Service.
        </p>

        <h2>Service Description and Donations</h2>
        <p>
          The Service is provided free of charge as an educational resource. We
          do not sell any products or services through the Website.
        </p>
        <p>
          The Service includes an optional donation feature that allows users to
          voluntarily support the Website's operation and maintenance. Donations
          are:
        </p>
        <ul>
          <li>Completely voluntary and optional</li>
          <li>Not required to access any features of the Service</li>
          <li>Non-refundable once processed</li>
          <li>Processed through third-party payment providers</li>
        </ul>
        <p>
          By making a donation, you acknowledge that you are voluntarily
          supporting the Service with no expectation of goods, services, or
          benefits in return beyond continued operation of the Website.
        </p>
        ...
        <ul>
          ...
          <li>Communication logs or user-generated content</li>
        </ul>
        <p>
          Any data transmission occurs solely between your device and our
          servers for the technical delivery of the Service content.
        </p>
        ...
        <p>
          Since the Service is provided free of charge and no transactions occur
          through the Service (except voluntary donations), the entire liability
          of the Company and any of its suppliers under any provision of this
          Terms shall be limited to 100 USD.
        </p>
        <p>
        ...
        <ul>
          <li>By email: whisperer.meta@gmail.com</li>
        </ul>
      </main>
      <Footer />
    </>
